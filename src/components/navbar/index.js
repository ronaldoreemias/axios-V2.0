            ...
            <header className={style.container}>
                <div className={style.textonav}>
                    ...
                    <div className={style.container_Palavras}>
                        <div className={style.palavras} ref={palavrasRef}>
                            <a href="/" className={style.active} onClick={closeMenu}>
                                <h2>Axios Tecno</h2>
                            </a>
                            <a href="/" className={style.active} onClick={closeMenu}>
                ...
                <nav className={style.nav}>
                    ...
                    <ul className={`${style.navList} ${isMenuOpen ? style.navListActive : ""}`}>
                        ...
                        <li>
                            <a href="/notificacao" className={style.active} onClick={closeMenu}>
                                Sistema
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="https://front-weld-six.vercel.app/" onClick={closeMenu}>
                                Fórum
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="/vagas" onClick={closeMenu}>
                                Vagas de Emprego
                            </a>
                        </li>
                    </ul>
                ...
                <div className={`${style.overlay} ${isMenuOpen ? style.overlayActive : ""}`} onClick={closeMenu}></div>
            </header>
        </div>
    );
}
